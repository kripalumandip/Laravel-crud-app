...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                  ...
                  <textarea value="<?php echo e(old('description')); ?>" class="form-control" name="description" cols="30" rows="5" placeholder="Description"><?php echo e(old('description',$product->description)); ?></textarea>
                </div>
                <div class="mb-3">
...
</html><?php /**PATH C:\xampp\htdocs\crud-app\resources\views/products/edit.blade.php ENDPATH**/ ?>